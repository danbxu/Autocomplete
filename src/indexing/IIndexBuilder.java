...
public interface IIndexBuilder {
    ...
    public static  Comparator<Entry<Comparable ,Comparable>> createComparator() {

        //Create new comparator object and return the comparisons
        Comparator<Entry<Comparable ,Comparable>> compareThis = new 
                Comparator<Entry<Comparable ,Comparable>>() {
            @Override
